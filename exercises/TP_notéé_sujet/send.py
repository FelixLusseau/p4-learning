...
def get_random_flow():
    src_ip = socket.inet_ntoa(struct.pack("!I", 167837954))
    dst_ip = socket.inet_ntoa(struct.pack("!I", 168165890))
...
def main(n_packets, n_drops, fail_hops):
    ...
    eth_h = eth_header("00:00:0a:01:01:02", "00:01:0a:01:01:02", 0x800)
